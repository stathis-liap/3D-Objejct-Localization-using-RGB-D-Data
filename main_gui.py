...
class Main():
    def __init__(self, maskcolor = (255, 0, 255)):
        ...
        frame_count = 0
        self.mask_color = maskcolor  # Magenta
        box_color = (255, 0, 255)
        alpha = 0.5 
        pad = 40
            ...
            try:
                ...
                for r in results:
                    ...
                    for box in boxes:
                        ...
                        cv2.putText(rgb_frame, class_name, label_origin, FONT, FONT_SCALE, COLORS[cls], THICKNESS) #box color
                        ...
                        try:
                            ...
                            overlay_rgb[mask_clipped] = self.mask_color # on the bowl
                            ...
                            cv2.putText(rgb_frame, info_text, label_origin, FONT, FONT_SCALE, COLORS[cls], THICKNESS) #text color
